...
def turn_off_music():
    ...
    # execute("adb shell settings put system volume_system 0")
    # execute("adb shell settings put system volume_ring 0")
    print(execute("adb shell settings get system volume_music"))
