...
from app.utilites import ImageComparison, take_screenshot, get_last_screenshot_path, wait
from log.log import logger
from pages.base_page import is_button_get_on_screen, stop, is_loader_on_screen
